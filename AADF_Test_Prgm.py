...
Video_Test = '/Home/Jetson/Videos/YourVideoName.avi' # The path to your video and video name

# Select the output result video
VideoResult = '/Home/Jetson/Videos/Result.avi' # The path to your result video
...
flag_dyn_AADP = 1 # Choose the filter dynamic - 0 means low dynamic - 1 means high dynamic
